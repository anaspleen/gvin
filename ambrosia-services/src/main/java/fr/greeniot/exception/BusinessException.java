...
public class BusinessException extends Exception
{
   ...
   *     erreur métier
   */
  public static void logAndThrow(final Logger p_logger,
                                 final BusinessExceptionEnum p_businessExceptionEnum,
   ...
   *     exception causant l'erreur métier
   */
  public BusinessException(final BusinessExceptionEnum p_businessExceptionEnum,
  ...
  public enum BusinessExceptionEnum
  {
    ...
    CODE_4_REQUETE_RECHERCHE_ROSA_INVALIDE(4, 400, "Requête de recherche ROSA invalide",
                                           "La requête de recherche ROSA est malformée ou comporte des valeurs "
                                               + "invalides."),
    /** Code erreur 5, statut Http 500, "Code réponse HTTP inattendu". */
    ...
    CODE_7_RESSOURCE_NON_TROUVEE(7, 404, "Ressource non trouvée",
                                 "La ressource n'a pas été trouvée (l'identifiant est correct mais n'a fourni n'a "
                                     + "retourné aucune valeur)."),
    /** Code erreur 8, statut Http 404, "Ressource non trouvée pour la version donnée". */
    ...
    CODE_14_NON_AUTHENTIFIE(14, 401, "Echec lors de l'authentification",
                            "Les informations fournies par le téléservice utilisateur de l'api n'ont pas permis de "
                                + "l'authentifié"),
    /** Code erreur 15, statut Http 403, "L'accès à la ressource est refusé". */
    ...
    private BusinessExceptionEnum(final int codeErreur,
